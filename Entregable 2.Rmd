...
```{r}
gitLink="https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/Prop_mujeres_puestos_directivos_VD.csv"
vardep=rio::import(gitLink)
```

```{r}
library(dplyr)
select(vardep, V1, V2, V64, V65)
```

```{r}
dependiente <- select(vardep, V1, V2, V64, V65)
head(dependiente,10)
```
...
```{r}
colnames(dependiente) = c("pais","codigo","puestosdirec2019","puestosdirec2020")
```
...
```{r}
gitLink="https://raw.githubusercontent.com/KamilaGamarra/Est_2/main/KVI1_Pobreza.csv"
...
```{r}
gitLink="https://raw.githubusercontent.com/KamilaGamarra/Est_2/main/KVI2_ActivaM.csv"
...
```{r}
gitLink="https://raw.githubusercontent.com/KamilaGamarra/Est_2/main/KVI3_Prim_Sec.csv"
...
Parlamentos="https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/XVI1_Parlamentos.csv"
XParlamentos=import(Parlamentos)
```

```{r}
Gasteduc="https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/XVI2_Gasteduc.csv"
XGasteduc=import(Gasteduc)
```

```{r}
Vulnerable="https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/XVI3_Vulnerable.csv"
...
```{r}
WomenPower=("https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/MFVI1_Empoderamiento.csv")
WomenPower=import(WomenPower)
```

```{r}
GenderIneq=("https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/MFVI2_Inequidad.csv")
...
```{r}
FemalePart=("https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/MFVI3_Titularidad.csv")
...
```{r}
gitLink1="https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/LVI1_PBI.csv"
