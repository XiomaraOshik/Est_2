...
```{r echo=FALSE}
data = "[https://github.com/santiagomv29/PRACTICAS_ESTA2/raw/main/base_dataunificada.csv](https://github.com/XiomaraOshik/Est_2/blob/main/Entregable_2/data.csv)"
library(rio)
data = import(data)
library(magrittr)
BDU%>%
...
```{r echo=FALSE}
modelo4=list('parlamentos2020'=data)
modelsummary(modelo4, title = "OLS",
             stars = TRUE,
             output = "kableExtra")
```
