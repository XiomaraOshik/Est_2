---
title: "Proporción de escaños en el parlamento político ocupado por mujeres 2020 - Análisis de los resultados"
author: "Integrantes: Xiomara Oshikawa, Kamila Gamarra, Luciana Rojas, Maria Fernanda"
...
```{r echo=FALSE}
data = "https://raw.githubusercontent.com/XiomaraOshik/Est_2/main/Entregable_2/data.csv"
library(rio)
data = import(data)
library(magrittr)
data%>%
...
```{r echo=FALSE}
model=list('parlamentos2020'=data)
modelsummary(modelo1, title = "Regresión 1",
             stars = TRUE,
             output = "kableExtra")
```
...
```{r echo=FALSE}
model2=list('parlamentos2020'=data)
modelsummary(modelo2, title = "Regresión 2",
             stars = TRUE,
             output = "kableExtra")
```
...
```{r echo=FALSE}
equatiomatic::extract_eq(modelo3, use_coefs = TRUE)
```

```{r echo=FALSE}
model3=list('parlamentos2020'=data)
modelsummary(modelo3, title = "Regresión 3",
             stars = TRUE,
             output = "kableExtra")
```
...
```{r echo=FALSE}
model4=list('parlamentos2020'=data)
modelsummary(modelo3, title = "Regresión 4",
             stars = TRUE,
             output = "kableExtra")
```
