...
En promedio, la proporción de las mujeres que ocupan un escaño en el parlamento de cada país oscila un 24.73. La propoción de escaños parlamentarios ocupados por mujeres se puede observar en la tabla a continuación:
...
ggplot(data, aes(x=PBI_2015, y=parlamentos2020)) + 
  geom_point(size=1.5, shape=23, color="blue") +
  geom_text(label=data$codigo, vjust=-0.5, hjust = 1,color="black", size=3) +
  
      labs(title = "Proporción de escaños parlamentarios ocupados por mujeres y PBI a nivel mundial",
       x = "PBI_2015",
       y = "Proporción de escaños parlamentarios ocupados por mujeres") +
