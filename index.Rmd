...
Con la finalidad de evidenciar la relación y efecto de cada variable independiente en la dependiente, proporción de escaños ocupados por mujeres en el parlamento, a continuación como paso preliminar a la presentación de regresiones, se realizarán correlaciones de cada variable independiente con la dependiente para visualizar la relevancia de cada una en nuestro análisis. 
